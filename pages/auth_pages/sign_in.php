...
<body class="bg-[#0a0a0a] text-white min-h-screen flex items-center justify-center flex-col lg:flex-row px-10 pb-5 gap-[3em]">
    ...
    <div class="bg-[#14233C] p-8 rounded-3xl w-full lg:w-[40em] px-[3em] flex flex-col justify-center">
        <h2 class="text-[2em] font-bold text-center mb-[1.5em]">SIGN IN</h2>
        ...
        <form method="POST" action="../../processes/sign_in_process.php" class="space-y-[5em]">
            <!-- Email -->
            <div class="flex flex-row gap-x-10">
                <img src="../../assets/images/username:email_icon.png" alt="username/email icon" class="w-[5em] h-[5em]">
                <div class="w-full">
                    <label class="block text-[1em] font-bold mb-1 flex items-center">
                        Email Address
                    </label>
