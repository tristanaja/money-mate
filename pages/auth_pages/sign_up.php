...
<body class="bg-[#0a0a0a] text-white min-h-screen flex items-center justify-center flex-col lg:flex-row px-10 pb-5 gap-[2em] lg:gap-[4em]">
    ...
    <div class="bg-[#14233C] py-8 rounded-3xl w-full lg:w-[30em] px-[3em] flex flex-col justify-center">
        <h2 class="text-[1.5em] md:text-[2em] font-bold text-center mb-[1.5em]">SIGN UP</h2>

        <?php if ($error): ?>
            <div id="errorModal" class="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
                <div class="bg-[#14233C] text-black w-[90%] max-w-md py-8 px-10 rounded-xl shadow-lg flex flex-col justify-center">
        ...
        <form method="POST" action="../../processes/sign_up_process.php" class="space-y-[2em] md:space-y-[3em]">
            <!-- Username -->
            <div class="flex flex-row gap-x-10">
                <img src="../../assets/images/username_icon.png" alt="username icon" class="hidden md:inline w-[5em] h-[5em]">
                <div class="w-full">
            ...
            <!-- Email -->
            <div class="flex flex-row gap-x-10">
                <img src="../../assets/images/email_icon.png" alt="email icon" class="hidden md:inline w-[5em] h-[5em]">
                <div class="w-full">
                    <label class="block text-[0.8rem] md:text-[1rem] font-bold mb-1 flex items-center">
                        Email Address
                    </label>
