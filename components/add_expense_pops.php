...
<!-- Add Expense Modal -->
<div id="addExpenseModal" class="backdrop-blur-sm fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 hidden">
    <div class="bg-gradient-to-br from-[#0b192c] to-[rgba(11,25,44,0.75)] p-6 rounded-xl w-[90%] max-w-md text-white">
        ...
        <form action="processes/expense/add_expense_process.php" method="POST">
            <!-- Title -->
            ...
            <textarea name="description" rows="2" required placeholder="Description"
                class="w-full h-[100px] p-3 rounded border border-gray-500 bg-transparent mb-3 placeholder-gray-400 text-white text-sm resize-none focus:outline-none focus:ring-2 focus:ring-orange-500"></textarea>
            ...
            <div class="flex gap-4">
                <button type="button" onclick="toggleAddExpense()"
